...
export const allProducts = [
  ...
  },
  {
    ...
    badges: [{ label: 'HOT', color: 'bg-cyan-500' }],
    soldCount: 290,
    total: 300,
    isPopular: true,
    isBestSeller: false,
  ...
  },
  {
    ...
    gender: 'Nữ',
    sizes: ['38', '39', '40'],
    badges: [{ label: 'HOT', color: 'bg-gold' }],
    soldCount: 150,
    total: 200,
    isPopular: true,
    isBestSeller: true,
  ...
  },
  {
    ...
    badges: [{ label: 'HOT', color: 'bg-green-500' }],
    soldCount: 120,
    total: 200,
    isPopular: false,
    isBestSeller: false,
  ...
  },
  {
    ...
    badges: [{ label: '-45%', color: 'bg-accent shadow-sm' }, { label: 'HOT', color: 'bg-accent2-dim shadow-sm' }],
    soldCount: 91,
    total: 100,
    images: [
